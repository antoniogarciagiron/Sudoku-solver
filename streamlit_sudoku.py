    ...
    if sudoku:
        ...
        try:
            ...
            for i in result:
                num = i[1]
                l.append(num)  
            st.write("## :trophy: The solved sudoku:")    
            st.write(
                    f"""- - - - - - - - - - -
            ...
            st.write("Thanks for using Super Sudoku Solver! :rocket:") 
        except Exception:
            st.write("Ups, something happened! :sob:")
    else: 
        st.write("Upload a sudoku first! :sweat_smile:")
